...
% Values to write 
valuesToWrite = arrayfun(@(x) {DataBase.InstalledCapacityForOutsideMod{'Grow rate to NZO model', 'MOD'}}, 1:numRows, 'UniformOutput', false); % Create array of arrays for rows
disp(valuesToWrite);
...
ranges = {
    'scenarios-input!C3:E3', DataBase.InstalledCapacityForOutsideMod{2:4, 'MOD'}';
};
