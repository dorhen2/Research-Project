...
valuesToWrite = arrayfun(@(x) {DataBase.InstalledCapacityForOutsideMod{'Grow rate to NZO model', 'ADV+NUC'}}, 1:numRows, 'UniformOutput', false); % Create array of arrays for rows
...
ranges = {
    'scenarios-input!C3:E3', DataBase.InstalledCapacityForOutsideMod{2:4, 'ADV+NUC'}';
};
